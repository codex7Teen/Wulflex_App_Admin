...
class ScreenAddClothing extends StatefulWidget {
  final String screenTitle;
  const ScreenAddClothing({super.key, required this.screenTitle});

  @override
  State<ScreenAddClothing> createState() => _ScreenAddClothingState();
}

class _ScreenAddClothingState extends State<ScreenAddClothing> {
