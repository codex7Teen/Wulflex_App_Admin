...
import 'package:wulflex_admin/models/order_model.dart';
import 'package:wulflex_admin/screens/main_screens/order_screens/order_details_screen.dart';
                ...
                child: ListView.separated(
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        onTap: () => NavigationHelper.navigateToWithoutReplacement(context, ScreenOrderDetails(orderModel: order)),
                        child: Container(
